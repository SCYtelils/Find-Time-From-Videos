...
class ClockSyn(torch.utils.data.Dataset):
  def __init__(self, augment=True, use_homography=True, use_artefacts=True, size=3200):
    self.size = size
...
class ClockEval(torch.utils.data.Dataset):
  def __init__(self, dataset):
    ...
    base_dir = 'C:/Users/Administrator/Desktop/itsabouttime-main/itsabouttime-main/data/'
    if dataset == 'coco':
      anno_dir = '../data/coco_final.csv'
      data_dir = base_dir + 'coco/trainval_images'
    if dataset == 'openimages':
      anno_dir = '../data/openimg_final.csv'
      data_dir = base_dir + 'openimages/data'
    if dataset == 'clockmovies':
      anno_dir =  '../data/movies_final.csv'
      data_dir = base_dir + 'movieimages/images'
...
class ClockTimelapse(torch.utils.data.Dataset):
  def __init__(self, anno_dir, augment=True):
    self.data_dir = 'C:/Users/Administrator/Desktop/itsabouttime-main/itsabouttime-main/data/filtered_data/'
